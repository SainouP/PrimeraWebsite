...
loader.load('/PrimeraWebsite/RENDER/pc_gamer_animation.glb', function(gltf) {
...
// Redirigir al hacer clic en el botón "Volver al Inicio"
document.getElementById('Fijo-btn').addEventListener('click', function() {
    window.location.href = '/PrimeraWebsite/PAGE2/HTML/exploracion.html';  // Redirige a la página principal
});
